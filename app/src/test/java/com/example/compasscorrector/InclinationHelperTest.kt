...
class InclinationHelperTest {
    ...
    fun testInclinationCalculation() {
        ...
        val (alt1, _) = InclinationHelper.calculateAltitudeAndOrientation(0f, 0f)
        assertEquals(0f, alt1, 0.01f)

        // Tilted exactly 45 deg on one axis
        val (alt2, _) = InclinationHelper.calculateAltitudeAndOrientation(45f, 0f)
        assertEquals(45f, alt2, 0.01f)

        val (alt3, _) = InclinationHelper.calculateAltitudeAndOrientation(0f, 45f)
        ...
        // acos(0.5) = 60 degrees.
        val (alt4, _) = InclinationHelper.calculateAltitudeAndOrientation(45f, 45f)
